      ...
      >
        ...
        :style="`
          transform:
            ...
            translateX(${editable.group.first.horizontal}px)
      ...
      >
        ...
        :style="`
          transform:
            ...
            translateX(${editable.group.second.horizontal}px)
      ...
      >
        ...
        :style="`
          transform:
            ...
            translateX(${editable.group.third.horizontal}px)
      ...
      >
        ...
        :style="`
          transform:
            ...
            translateX(${editable.group.forth.horizontal}px)
